...
var hint_types_in_battle_panel = [HintType.CRIT, HintType.BLOCK, HintType.REPAIR, HintType.MULTITAME, HintType.HEATUP, HintType.HARDEN, HintType.BALL]
